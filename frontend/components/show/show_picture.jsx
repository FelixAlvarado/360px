  ...
  render() {
    return (
      <div className="show-div">
        ...
        <div c
          lassName="show-child-2">
          <p>  <img className = "image-placeholder" src="https://s15.postimg.cc/8agnin31n/seth_curry.jpg" /><span className="show-username"><Link className={`show-link ${this.nameLink()}`} to={`/profile/${this.props.user.id}`} >{this.props.user.username}</Link></span></p>
